        ...
        <div class="row justify-content-center">
          <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5">
            <div class="px-4">
              ...
              <p class="text-white mt-4 mb-4">Password recovery whatsapp is sent successfully. Please check your inbox!</p>
              <!-- Go Back Button--><a class="btn btn-warning" href="auth">Go Home</a>
            </div>
          </div>
        </div>
      </div>
