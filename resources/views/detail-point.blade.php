  ...
  <body>
    ...
    <div class="header-area" id="headerArea">
      <div class="container h-100 d-flex align-items-center justify-content-between">
        <!-- Back Button-->
        <div class="back-button"><a href="point">
            <svg class="bi bi-arrow-left" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
              <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z"></path>
            </svg></a></div>
        <!-- Page Title-->
        <div class="page-heading">
          <h6 class="mb-0">Detail Point</h6>
        </div>
        <!-- Navbar Toggler-->
          ...
          <div class="d-flex align-items-start">
            <div class="card">
                <div class="card-body about-content-wrap">
                  ...
                  <p>It nicely views on all devices with smartphones, tablets, laptops &amp; desktops.</p><img class="mb-3 rounded" src="asset/img/bg-img/detail-point_1.png" alt="">
                  <p>A versatile e-commerce shop template. It is very nicely designed with modern features &amp; coded with the latest technology.</p>
                  ...
                  <div class="contact-btn-wrap text-center">
                    <p class="mb-2">For more information, submit a request.</p><a class="btn btn-primary w-100" href="status-penukaran-point"><i class="lni lni-life-ring me-2"></i>Tukar Point</a>
                  </div>
                </div>
              </div>
        </div>
