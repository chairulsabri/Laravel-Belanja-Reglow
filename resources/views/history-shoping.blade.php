    ...
    <div class="page-content-wrapper">
      <div class="container">
        ...
        <div class="section-heading d-flex align-items-center pt-3 justify-content-between">
          <h6>Order History</h6><a class="notification-clear-all text-secondary" href="#"></a>
        </div>
        <!-- Notifications Area-->
        <div class="notification-area pb-2">
          <div class="list-group">
            <!-- Single Notification--><a class="list-group-item readed d-flex align-items-center" href="notification-details"><span class="noti-icon"><i class="lni lni-ship"></i></span>
              <div class="noti-info">
                <h6 class="mb-0">12/Des/2024</h6><span>  Price: Rp. 12.000.000</span>
              </div></a>
        </div>
        <!-- Notifications Area-->
        <div class="notification-area pb-2">
