  ...
  <body>
    ...
    <div class="offcanvas offcanvas-start suha-offcanvas-wrap" tabindex="-1" id="suhaOffcanvas" aria-labelledby="suhaOffcanvasLabel">
      ...
      <div class="offcanvas-body">
        ...
        <ul class="sidenav-nav ps-0">
          ...
          <li><a href="auth"><i class="lni lni-power-switch"></i>Sign Out</a></li>
        </ul>
      </div>
    </div>
    <div class="page-content-wrapper">
      <div class="container">
              ...
              <table class="table mb-0">
                <tbody>
                  <tr>
                    ...
                    <td><img class="rounded" src="asset/img/product/detail.jpg" alt=""></td>
        ...
        <div class="cart-wrapper-area py-6">
            <div class="cart-table card mb-3">
              <div class="table-responsive card-body">
                <table class="table mb-0">
                  <tbody>
                    ...
                    <tr>
                      <th scope="row">2</th>
                      <td><img class="rounded" src="asset/img/product/detail.jpg" alt=""></td>
                      <td><a href="#">Bluetooth Speaker<span>$9.87 × 2</span></a></td>
                      <td>
                        <div class="quantity">
                          <p>Rp. 45.000</p>
                        </div>
                    ...
                    <tr>
                      <th scope="row">3</th>
                      <td><img class="rounded" src="asset/img/product/detail.jpg" alt=""></td>
                      <td><a href="#">Modern Gray Tops<span>$7 × 1</span></a></td>
                      <td>
                        <div class="quantity">
                            <p>Rp. 45.000</p>
                          </div>
            ...
            <div class="card cart-amount-area mt-3">
              <div class="card-body d-flex align-items-center justify-content-between">
                <h5 class="total-price mb-0">$<span class="counter">38.84</span></h5><a class="btn btn-warning" href="checkout-payment">Checkout Now</a>
              </div>
            </div>
          </div>
      </div>
